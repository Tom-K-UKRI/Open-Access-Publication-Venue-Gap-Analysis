...
names(dimensions_uk) <- make.names(names(dimensions_uk), unique = TRUE)

# Rename to Dimensions
dimensions <- dimensions_uk
...
merged_pvga_uk <- merged_pvga


#XXXXXXXXXX
# 7. WRITE MERGED_PVGA TO EXCEL AND RDA ----

# openxlsx::write.xlsx(as.data.frame(merged_pvga_uk), 'Data/merged_pvga_uk.xlsx')
save(merged_pvga_uk, file = "Data/merged_pvga_uk.Rda")
...
openxlsx::write.xlsx(as.data.frame(dimensions), 'Data/Dimensions_UK.xlsx')
save(dimensions, file = "Data/Dimensions_UK.Rda")